...
<div class="slider_bg">
    <div class="slider">
        <ul class="items">
            <li>
                <img src="<?php echo e(asset('asset/images/img1.jpg')); ?>" alt="">
                <div class="banner">
            ...
            <li>
                <img src="<?php echo e(asset('asset/images/img2.jpg')); ?>" alt="">
                <div class="banner">
            ...
            <li>
                <img src="<?php echo e(asset('asset/images/img3.jpg')); ?>" alt="">
                <div class="banner">
    ...
    <div class="slider-response">
        <div class="rslides_container">
            <ul class="rslides" id="slidez">
                <li><img src="<?php echo e(asset('asset/images/img1.jpg')); ?>" alt=""></li>
                <li><img src="<?php echo e(asset('asset/images/img2.jpg')); ?>" alt=""></li>
                <li><img src="<?php echo e(asset('asset/images/img3.jpg')); ?>" alt=""></li>
            </ul>
        </div>
    </div>
</div>
