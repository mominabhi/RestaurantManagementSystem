            ...
            <div class="wrap-col">
                <div class="box">
                    <div>
                        ...
                        <figure><img src="<?php echo e(asset('asset/images/page1_img1.jpg')); ?>" alt=""></figure>
            ...
            <div class="wrap-col">
                <div class="box">
                    <div>
                        ...
                        <figure><img src="<?php echo e(asset('asset/images/page1_img2.jpg')); ?>" alt=""></figure>
            ...
            <div class="wrap-col">
                <div class="box">
                    <div>
                        ...
                        <figure><img src="<?php echo e(asset('asset/images/page1_img3.jpg')); ?>" alt=""></figure>
