        ...
        <div class="span12">
            ...
            <div class="widget green">
                ...
                <div class="widget-body form">
                    <!-- BEGIN FORM-->
                    <form class="cmxform form-horizontal" method="post" action="<?php echo e(route('admin.add_food')); ?>"
                        ...
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <input class="span6 " name="price" type="number"/>
                            </div>
                        </div>
                        <div class="control-group ">
                        ...
                        <div class="control-group ">
                            ...
                            <div class="controls">
                                <input class="span6" name="image" type="file"/>
                            </div>
                        </div>
