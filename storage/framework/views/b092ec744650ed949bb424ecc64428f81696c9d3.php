            ...
            <div class="wrap-col">
                <div class="box">
                    <div>
                        ...
                        <figure><img src="<?php echo e(asset('asset/images/page2_img2.jpg')); ?>" alt=""></figure>
        ...
        <div class="wrapper">
            <div class="col-1-3"><div class="wrap-col">
                    <div class="wrapper pad_bot1">
                        <figure class="pad_bot1"><img src="<?php echo e(asset('asset/images/page2_img3.jpg')); ?>" alt=""></figure>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt.
                    </div>
                </div></div>
            <div class="col-1-3"><div class="wrap-col mag-1">
                    <div class="wrapper pad_bot1">
                        <figure class="pad_bot1"><img src="<?php echo e(asset('asset/images/page2_img4.jpg')); ?>" alt=""></figure>
            ...
            <div class="col-1-3"><div class="wrap-col mag-1">
                    <div class="wrapper pad_bot1">
                        <figure class="pad_bot1"><img src="<?php echo e(asset('asset/images/page2_img5.jpg')); ?>" alt=""></figure>
